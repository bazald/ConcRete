...
#ifndef ZENI_CONCURRENCY_CACHE_LINE_SIZE
#define ZENI_CONCURRENCY_CACHE_LINE_SIZE 64
#endif

#define ZENI_CONCURRENCY_CACHE_ALIGN alignas(ZENI_CONCURRENCY_CACHE_LINE_SIZE)
