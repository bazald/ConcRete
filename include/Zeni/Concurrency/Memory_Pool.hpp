...
namespace Zeni::Concurrency {
  ...
  public:
    ...
    /// Get a cached memory block or allocate one as needed.
    ZENI_CONCURRENCY_LINKAGE virtual void * allocate(const size_t size, const std::align_val_t alignment) noexcept = 0;
    ...
    /// Return a memory block to be cached (and eventually freed).
    ZENI_CONCURRENCY_LINKAGE virtual void release(void * const ptr, const std::align_val_t alignment) noexcept = 0;
