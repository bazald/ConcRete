...
namespace Zeni::Rete {
  ...
  public:
    ...
    typedef Concurrency::Hash_Trie_S2<std::shared_ptr<const Symbols>, Concurrency::Super_Hash_Trie<Token_Trie, Token_Trie>, hash_deref<Symbols>, compare_deref_eq> Symbols_Trie;
