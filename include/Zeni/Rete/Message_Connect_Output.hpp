...
namespace Zeni::Rete {
  ...
  class Message_Connect_Output : public Rete::Message {
  ...
  public:
    ZENI_RETE_LINKAGE Message_Connect_Output(const std::shared_ptr<Node> recipient, const std::shared_ptr<Network> network, const std::shared_ptr<const Node> output);
