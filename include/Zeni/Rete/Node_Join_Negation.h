...
namespace Zeni {
  ...
  namespace Rete {
    ...
    class ZENI_RETE_LINKAGE Rete_Negation_Join : public Node {
    ...
    public:
      Rete_Negation_Join(Variable_Bindings bindings_);
      ...
      static std::shared_ptr<Node_Join_Negation> find_existing(const Variable_Bindings &bindings, const std::shared_ptr<Node> &out0, const std::shared_ptr<Node> &out1);
