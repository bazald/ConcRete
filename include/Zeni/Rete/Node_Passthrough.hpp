...
namespace Zeni::Rete {
  ...
  class Node_Passthrough : public Node_Unary {
    ...
    Node_Passthrough(const std::shared_ptr<Pseudonode> input);

  public:
    ZENI_RETE_LINKAGE static std::shared_ptr<Node_Passthrough> Create(const std::shared_ptr<Network> network, const std::shared_ptr<Pseudonode> input);
