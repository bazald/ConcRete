...
namespace Zeni::Rete {
  ...
  class Message_Status_Nonempty : public Rete::Message {
  ...
  public:
    ZENI_RETE_LINKAGE Message_Status_Nonempty(const std::shared_ptr<Node> recipient, const std::shared_ptr<Network> network, const std::shared_ptr<const Node> sender);
