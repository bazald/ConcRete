...
namespace Zeni::Rete {
  ...
  class Node_Filter_1 : public Node_Unary {
    ...
    Node_Filter_1(const std::shared_ptr<Network> network, const std::shared_ptr<const Symbol> &symbol0);
  ...
  public:
    ...
    ZENI_RETE_LINKAGE static std::shared_ptr<Node_Filter_1> Create(const std::shared_ptr<Network> network, const std::shared_ptr<Concurrency::Job_Queue> job_queue, const std::shared_ptr<const Symbol> &symbol0);
