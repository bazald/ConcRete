...
namespace Zeni {
  ...
  namespace Rete {
    ...
    ZENI_RETE_LINKAGE void bind_to_negation_join(const std::shared_ptr<Network> &network, const std::shared_ptr<Node_Join_Negation> &join, const std::shared_ptr<Node> &out0, const std::shared_ptr<Node> &out1);
