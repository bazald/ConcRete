...
namespace Zeni::Rete {
  ...
  public:
    ZENI_RETE_LINKAGE Message_Token_Remove(const std::shared_ptr<Node> recipient, const std::shared_ptr<Network> network, const std::shared_ptr<const Node> parent, const std::shared_ptr<const Token> token);
