...
namespace Zeni {
  ...
  namespace Rete {
    ...
    public:
      ...
      ZENI_RETE_LINKAGE virtual bool operator==(const char * const &) const;
    ...
    public:
      ...
      ZENI_RETE_LINKAGE bool operator==(const char * const &value_) const override;
    ...
    public:
      ZENI_RETE_LINKAGE Symbol_Identifier(const char * const &value_);
