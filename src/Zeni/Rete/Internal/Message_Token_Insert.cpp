...
namespace Zeni::Rete {
  ...
  Message_Token_Insert::Message_Token_Insert(const std::shared_ptr<Node> recipient, const std::shared_ptr<Network> network, const std::shared_ptr<Node> parent_, const std::shared_ptr<const Token> token_)
