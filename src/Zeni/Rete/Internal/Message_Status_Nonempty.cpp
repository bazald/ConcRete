...
namespace Zeni::Rete {
  ...
  Message_Status_Nonempty::Message_Status_Nonempty(const std::shared_ptr<Node> recipient, const std::shared_ptr<Network> network, const std::shared_ptr<Node> child_)
