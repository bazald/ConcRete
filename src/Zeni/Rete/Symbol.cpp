...
namespace Zeni {
  ...
  namespace Rete {
    ...
    bool Symbol::operator==(const std::string &) const { return false; }
    ...
    Symbol_Constant_String::Symbol_Constant_String(const std::string &value_) : value(value_) {}

    Symbol_Constant_String * Symbol_Constant_String::clone() const { return new Symbol_Constant_String(value); }
    ...
    bool Symbol_Constant_String::operator==(const Symbol_Constant_String &rhs) const { return value == rhs.value; }
    bool Symbol_Constant_String::operator!=(const Symbol_Constant_String &rhs) const { return value != rhs.value; }
    bool Symbol_Constant_String::operator<(const Symbol_Constant_String &rhs) const { return value < rhs.value; }
    bool Symbol_Constant_String::operator<=(const Symbol_Constant_String &rhs) const { return value <= rhs.value; }
    bool Symbol_Constant_String::operator>(const Symbol_Constant_String &rhs) const { return value > rhs.value; }
    ...
    bool Symbol_Constant_String::operator==(const std::string &value_) const { return value_ == value; }
    ...
    Symbol_Identifier::Symbol_Identifier(const std::string &value_) : value(value_) {}

    Symbol_Identifier * Symbol_Identifier::clone() const { return new Symbol_Identifier(value); }
    ...
    bool Symbol_Identifier::operator==(const Symbol_Identifier &rhs) const { return value == rhs.value; }
    bool Symbol_Identifier::operator!=(const Symbol_Identifier &rhs) const { return value != rhs.value; }
    bool Symbol_Identifier::operator<(const Symbol_Identifier &rhs) const { return value < rhs.value; }
    bool Symbol_Identifier::operator<=(const Symbol_Identifier &rhs) const { return value <= rhs.value; }
    bool Symbol_Identifier::operator>(const Symbol_Identifier &rhs) const { return value > rhs.value; }
    ...
    bool Symbol_Identifier::operator==(const std::string &value_) const { return value_ == value; }
...
bool operator==(const std::string &lhs, const Zeni::Rete::Symbol &rhs) { return rhs == lhs; }
