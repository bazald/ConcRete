...
namespace Zeni::Rete {
  ...
  Message_Connect_Output::Message_Connect_Output(const std::shared_ptr<Node> recipient, const std::shared_ptr<Network> network, const std::shared_ptr<const Node> child_)
